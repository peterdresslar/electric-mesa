...
def main():
    ...
    parser.add_argument('--n', type=int, default=5, help='Number of generating companies')
    parser.add_argument('--m', type=float, default=-5, help='Slope of price-capacity relationship')
    parser.add_argument('--b', type=float, default=1000, help='Intercept of price-capacity relationship')
    ...
    parser.add_argument('--mechanism', choices=['uniform', 'discriminatory', 'ownbid'], 
                       default='uniform', help='Pricing mechanism')
    ...
    print(f"Mean GenCo profit: {np.mean(np.sum(results['GenCo_profits'], axis=1)):,.2f}")
